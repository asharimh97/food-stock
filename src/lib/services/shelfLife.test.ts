...
describe('Shelf Life Logic', () => {
    it('calculates fresh red meat correctly (3 days)', () => {
        const bestBefore = calculateBestBefore('2024-01-01T00:00:00.000Z', 'red_meat', 'fresh', 'chiller');
        expect(new Date(bestBefore).toISOString().startsWith('2024-01-04')).toBe(true);
    });

    it('calculates frozen red meat correctly (180 days)', () => {
        const bestBefore = calculateBestBefore('2024-01-01T00:00:00.000Z', 'red_meat', 'frozen', 'freezer');
    ...
    it('handles packaged food opened state correctly (6 days)', () => {
        const bestBefore = calculateBestBefore('2024-01-01T00:00:00.000Z', 'packaged', 'opened', 'shelf');
    ...
    it('prioritizes user expiry for packaged food if shorter', () => {
        const bestBefore = calculateBestBefore('2024-01-01T00:00:00.000Z', 'packaged', 'opened', 'shelf', '2024-01-05T00:00:00.000Z');
